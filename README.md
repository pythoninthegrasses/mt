...
|----------|--------------|----------|
| macOS | Apple Silicon (ARM64) | [mt_1.6.0_aarch64.dmg](https://github.com/pythoninthegrasses/mt/releases/download/v1.6.0/mt_1.6.0_aarch64.dmg) |
| Linux | x86_64 (amd64) | [mt_1.6.0_amd64.deb](https://github.com/pythoninthegrasses/mt/releases/download/v1.6.0/mt_1.6.0_amd64.deb) |
| Windows | x64 | [mt_1.6.0_x64-setup.exe](https://github.com/pythoninthegrasses/mt/releases/download/v1.6.0/mt_1.6.0_x64-setup.exe) |
<!-- DOWNLOADS:END -->
