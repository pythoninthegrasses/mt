...
#[tauri::command]
pub(crate) fn playlist_list(db: State<'_, Database>) -> Result<PlaylistListResponse, String> {
...
#[tauri::command]
pub(crate) fn playlist_add_tracks(
    app: AppHandle,
    db: State<'_, Database>,
    playlist_id: i64,
    track_ids: Vec<i64>,
...
#[tracing::instrument(skip(app, db))]
#[tauri::command]
pub(crate) fn playlist_remove_track(
    app: AppHandle,
    db: State<'_, Database>,
    playlist_id: i64,
    position: i64,
...
#[tracing::instrument(skip(app, db))]
#[tauri::command]
pub(crate) fn playlist_reorder_tracks(
    app: AppHandle,
    db: State<'_, Database>,
    playlist_id: i64,
    from_position: i64,
...
#[tracing::instrument(skip(app, db))]
#[tauri::command]
pub(crate) fn playlists_reorder(
    app: AppHandle,
    db: State<'_, Database>,
    from_position: i64,
    to_position: i64,
...
#[tracing::instrument(skip(db))]
#[tauri::command]
pub(crate) fn playlist_generate_name(
    db: State<'_, Database>,
    base: Option<String>,
