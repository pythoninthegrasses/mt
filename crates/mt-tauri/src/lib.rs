...
use commands::{
    ...
    queue_play_context, queue_play_next_track, queue_play_previous_track, queue_remove,
    queue_reorder, queue_set_current_index, queue_set_loop, queue_set_shuffle, queue_shuffle,
    queue_skip_next, queue_skip_previous, settings_get, settings_get_all, settings_reset,
    settings_set, settings_update, stats_generate_chart_grid, stats_get_genres, stats_get_overview,
    stats_get_plays_over_time, stats_get_top_artists,
};
...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            queue_set_loop,
            queue_add_play_next,
            queue_play_next_track,
            queue_play_previous_track,
            queue_skip_next,
            queue_skip_previous,
            queue_check_integrity,
            queue_play_context,
            playlist_list,
            playlist_create,
            playlist_get,
