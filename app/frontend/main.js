...
import { promptWatchedFolderConfirmation } from './js/utils/watched-folders.js';
      ...
      if (type === 'over') {
        ...
        if ((!paths || paths.length === 0) && window._mtDraggedTrackIds && position) {
          ...
          if (playlistButton) {
            ...
            console.log(
              '[main] Internal drop on playlist:',
              playlistId,
              playlistName,
              'tracks:',
            ...
            try {
              ...
              if (result.added > 0) {
                ...
                ui.toast(
                  `Track${
                    window._mtDraggedTrackIds.length > 1 ? 's' : ''
        ...
        if (paths && paths.length > 0) {
          try {
            ...
            if (result.added > 0) {
              ...
              promptWatchedFolderConfirmation(paths);
